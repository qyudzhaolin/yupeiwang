<?php
//接口地址-仿真环境
define('MSURL', 'http://10.18.32.200:8080/ypwmsserv/');//接口url地址

//物流链接地址
define('TMS_URL', 'http://ctms.yupeiwang.com/ctms-qt/');//物流单号
define('WMS_URL', 'http://cwms.yupeiwang.com/cwms-qt/');//出库单号
