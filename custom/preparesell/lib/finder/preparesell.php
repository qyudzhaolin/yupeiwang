...
class preparesell_finder_preparesell{
    ...
    public function column_edit($row){
        ...
        return '<a href="index.php?app=preparesell&ctl=admin_preparesell&act=edit_rule&finder_id='.$_GET['_finder']['finder_id'].'&p[0]='.$row['prepare_id'].'&p[1]='.$_GET['view'].'"target="_blank">'.app::get('b2c')->_('编辑').'</a>';
    }
