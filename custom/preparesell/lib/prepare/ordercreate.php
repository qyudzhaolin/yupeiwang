...
class preparesell_prepare_ordercreate {
     ...
     * @access public
     * @param array $order
     * @param array $orderRow 订单row
     * @return bool
     * @version 1 Jul 15, 2011
     */
    public function order_notify($order,$orderRow=[]) {
        ...
        $itemnum = $orderRow['itemnum'] ? (int)$orderRow['itemnum'] : 1;
        $initial_num=$prepare['initial_num']-$itemnum;
        // ee($orderRow);
        $data=array(
