    ...
    'columns'=>array(
       ...
       'fund' =>
        array (
            ...
            'default' => 'other',
            'required' => true,
            'comment' => app::get('b2c')->_('款项'),
            'editable' => false,
            'label' => app::get('b2c')->_('款项'),
            'width' => 75,
            'filtertype' => 'yes',
            'is_title' => true,
            'filterdefault' => true,
        ...
        'prepare_status' =>
         array (
             'type' => array(
                 'wait_y' => app::get('b2c')->_('等待付款[预付款]'),
                 'paid_y' => app::get('b2c')->_('已付款[预付款]'),

                 'wait_z' => app::get('b2c')->_('等待付款[中期进度款]'),
                 'paid_z' => app::get('b2c')->_('已付款[中期进度款]'),

                 'wait_w' => app::get('b2c')->_('等待付款[尾款]'),
                 'paid_w' => app::get('b2c')->_('已付款[正在备货]'),
                 'other' => app::get('b2c')->_('其他'),
             ),
             'default' => 'other',
             'required' => true,
             'comment' => app::get('b2c')->_('预售订单状态'),
             'editable' => false,
             'label' => app::get('b2c')->_('预售订单状态'),
             'width' => 75,
             'filtertype' => 'yes',
             'is_title' => true,
             'filterdefault' => true,
        ...
        'label'=>app::get('b2c')->_('预售活动号'),
        'comment'=>app::get('b2c')->_('预售活动号'),
        'order' => 12,
        'width' => 100,
        ),
        'member_id' =>
