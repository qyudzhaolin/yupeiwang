...
$db['archive_return_product']=array (
  'columns' => 
  array (
    'order_id' => 
    array (
      'type' => 'table:archive_orders@b2c:order_id',
      'default' => '0',
      'required' => true,
      'default' => 0,
      'editable' => false,
    ...
    'member_id' => 
    array (
      'type' => 'table:members@b2c:member_id',
      'default' => '0',
      'required' => true,
      'editable' => false,
      'in_list' => true,
    ...
    array(
        'type' => 'longtext',
        'editable' => false,
        'label' => app::get('aftersales')->_('顾客填写的物流信息'),
    ),
    'memo' =>
    array(
        'type' => 'longtext',
        'editable' => false,
        'label' => app::get('aftersales')->_('接口备注'),
    ),
    'type' => array(
        'type' => array(
