...
abstract class ectools_analysis_abstract 
{
    ...
    public function set_params($params) 
    {
        ...
        if(isset($this->analysis_config)){
            ...
            $time_from = date("Y-m-d", strtotime("-30 days"));//TODO
        }
        // $time_to = date("Y-m-d", strtotime($time_from)+86400*7-1);
        $time_to = date("Y-m-d");//TODO
        ...
        $this->_params['report'] = ($this->_params['report']) ? $this->_params['report'] : 'day';//TODO
        $this->_params['target'] = ($this->_params['target']) ? $this->_params['target'] : '';//TODO
    ...
    public function graph() 
    {
        ...
        $this->_render->pagedata['targets'] = $this->targets;
        $this->_render->pagedata['charts_action'] = $this->charts_action;//图表的action
        ...
        $this->_render->pagedata['iframe_width'] = $this->graph_options['iframe_width'];
        return true;
    }//End Function
