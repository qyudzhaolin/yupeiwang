...
//正式环境
define("PAYURL",     "https://www.china-clearing.com/Gateway/InterfaceI");
define("TXURL",    "https://www.china-clearing.com/Gateway/InterfaceII");
...
class ectools_payment_plugin_cpcn_service extends ectools_payment_app
{
...
// 签名函数
    function cfcasign_pkcs12($plainText,$file)
    {
        ...
        fclose($fd);
        $res = openssl_pkcs12_read($p12buf, $p12cert, '0ip7FzKeSCg6xFS9');
        $pkeyid = $p12cert["pkey"];
        $binary_signature = "";
