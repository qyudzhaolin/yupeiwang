        ...
        array (
                ...
                array (
                    'type' =>
                        array (
                            ...
                            'contract' => app::get('b2c')->_('合约订单'),
                            'bail' => app::get('b2c')->_('保证金'),
                        ),
            ...
            'payment_offline' =>
                array (
                    'type' =>
                        array (
                            0 => app::get('b2c')->_('不是货到付款'),
                            -1 => app::get('b2c')->_('货到付款'),
                        ),
                    'default' => '0',
                    'required' => true,
                    'label' => app::get('b2c')->_('付款方式'),
                    'width' => 75,
                    'editable' => false,
                    'filtertype' => 'yes',
                    'filterdefault' => true,
