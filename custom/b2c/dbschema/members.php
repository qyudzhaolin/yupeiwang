...
$db['members']=array (
  ...
  array (
    ...
    'member_cate' =>
      array (
        'type' => array(
              'dealer' =>app::get('b2c')->_('经销商'),
              'e' =>app::get('b2c')->_('电商企业'),//Electric business
              'imex' =>app::get('b2c')->_('进出口企业'),//Import and export
              'supermarket' =>app::get('b2c')->_('商超企业'),
              'hotelfood' =>app::get('b2c')->_('酒店餐饮'),
              'business' =>app::get('b2c')->_('企事业单位'),
              'other' =>app::get('b2c')->_('其他'),
         ),
        'required' => false,
        'label' => app::get('b2c')->_('客户分类'),
        'width' => 80,
        'editable' => true,
        'default' =>'other',
        'in_list' => true,
