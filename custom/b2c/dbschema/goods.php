  ...
  array (
    ...
    array (
      ...
      'in_list' => true,
       ...
       'sales_mode'=>array (
         'type'=> array(
              1 =>app::get('b2c')->_('对内对外'),
              2 =>app::get('b2c')->_('仅对内'),
             
         ),
        'required' => false,
        'label' => app::get('b2c')->_('销售方式'),
        'width' => 80,
        'editable' => true,
        'default' =>1,
        'in_list' => true,
    ...
    array (
      'type' => 'money',
      'sdfpath' => 'product[default]/price/sales_price/price',
      'default' => '0',
      'required' => true,
      'label' => app::get('b2c')->_('销售标准价'),
      'width' => 75,
      'editable' => false,
      'filtertype' => 'number',
      'filterdefault' => true,
    ...
    'provenance_id' =>
    array (
      'type' => 'table:gprovenance',
      'sdfpath' => 'gprovenance/provenance_id',
    ...
    array (
      'type' => 'money',
      'sdfpath' => 'product[default]/price/merchandisecost/price',
      'default' => '0',
      'required' => true,
      'label' => app::get('b2c')->_('商品成本单价'),
      'width' => 75,
      'editable' => false,
      'filtertype' => 'number',
      'filterdefault' => true,
    ...
    array (
      'type' => 'money',
      'sdfpath' => 'product[default]/price/packingcost/price',
      'default' => '0',
      'required' => true,
   ...
   'weight' =>
    ...
    array (
      'type' => 'varchar(20)',
      'sdfpath' => 'product[default]/unitEn',
      'default' => '',
    ...
    array (
      'type' => 'varchar(20)',
      'sdfpath' => 'product[default]/owner_code',
      'default' => '',
    ...
    array (
      'type' => 'int(12)',
      'sdfpath' => 'product[default]/storehouse_id',
      'default' => 0,
    ...
    array (
      'type' => 'varchar(32)',
      'sdfpath' => 'product[default]/sku_code',
      'default' => '',
    ...
    array (
      'type' => 'tinyint(1)',
      'sdfpath' => 'product[default]/is_yp_store',
      'default' => 0,
