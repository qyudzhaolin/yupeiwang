...
class b2c_ctl_wap_gallery extends wap_frontpage{
    ...
    protected function cat_old($cat_id = 0){
    ...
    public function cat(){
        $burl = '/public/images/jimg/';
        $catlist = [
            '46'=>[
                '0'=>['cat_id'=>48,'cat_name'=>'鱼','pic'=>$burl . 'yu.png'],
                '1'=>['cat_id'=>200,'cat_name'=>'虾','pic'=>$burl . 'xia.png'],
                '2'=>['cat_id'=>208,'cat_name'=>'蟹贝','pic'=>$burl . 'xiebei.png'],
                '3'=>['cat_id'=>214,'cat_name'=>'海产干货','pic'=>$burl . 'ganhuo.png'],
                '4'=>['cat_id'=>221,'cat_name'=>'礼盒/组合','pic'=>$burl . 'lihe.png'],
                '5'=>['cat_id'=>46,'cat_name'=>'全部','pic'=>$burl . 'haixian.png'],
            ],
            '43'=>[
                '0'=>['cat_id'=>162,'cat_name'=>'进口牛肉','pic'=>$burl . 'niurou.png'],
                '1'=>['cat_id'=>167,'cat_name'=>'羊肉','pic'=>$burl . 'yangrou.png'],
                '2'=>['cat_id'=>43,'cat_name'=>'全部','pic'=>$burl . 'rou.png'],
            ],
        ];

        $this->pagedata['catlist'] = $catlist;
        $this->pagedata['title'] = '生鲜冻品';
        $this->page('wap/gallery/cat.html');
    }
    ...
    public function get_goods($filter,$page=1,$orderby,&$pagedata=false){
        ...
        $provenance = app::get('b2c')->model('gprovenance')->getList('provenance_id,gsource_area',null);
       if($provenance){
        foreach ($provenance as $key => $value) {
            $a[$value['provenance_id']]=$value['gsource_area'];
        }
       }
         foreach ($goodsData as $k => $v) {
           ...
           $goodsData[$k]['products']['provenance_name']= $p;
         }
        return $goodsData;
    }
