...
class b2c_mdl_provenance_attr extends dbeav_model{
    ...
    function init(){
        if(!$this->app->getConf('provenance.attr')){
    ...
    function getList($cols='*', $filter=array(), $offset=0, $limit=-1, $orderby=null){
        if($data = unserialize($this->app->getConf('provenance.attr'))){
    ...
    function save(&$data, $mustUpdate = NULL, $mustInsert = false){
        ...
        if($data['attr_id']){  //编辑
            foreach($old as $row){
                ...
                if(!$this->is_system($row['attr_tyname']) && isset($row['attr_column'])){
                    ...
                    $members = $this->app->model('gprovenance');
        ...
        return $this->app->setConf('provenance.attr',serialize($new));
    }
    ...
    function register_meta($schema){
        $mem_model = $this->app->model('gprovenance');
    ...
    function delete($attr_id,$subSdf=false){
        ...
        return $this->app->setConf('provenance.attr',serialize($data));
    }
   ...
   function update_order($orders){
    ...
    static function get_buildin_attr(){
         return array(
                array('attr_name'=>app::get('b2c')->_('原产国'),'attr_column'=>'country_of_origin',  'attr_type'=>'text','attr_required'=>'true','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'alpha','attr_tyname'=>app::get('b2c')->_('系统'),'attr_order'=>'1','attr_group'=>'defalut'),
                array('attr_name'=>app::get('b2c')->_('原产地'),'attr_column'=>'source_area','attr_type'=>'region','attr_required'=>'true','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'','attr_tyname'=>app::get('b2c')->_('系统'),'attr_order'=>'2','attr_group'=>'defalut'),
                array('attr_name'=>app::get('b2c')->_('进口资料配备（1)'),'attr_column'=>'import_information_1','attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'','attr_tyname'=>app::get('b2c')->_('系统'),'attr_order'=>'3','attr_group'=>'defalut'),
                array('attr_name'=>app::get('b2c')->_('资料配备（2)'),'attr_column'=>'import_information_2','attr_type'=>'gender','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'','attr_tyname'=>app::get('b2c')->_('系统'),'attr_order'=>'4','attr_group'=>'defalut'),
                ...
                array('attr_name'=>app::get('b2c')->_('资料配备（3)'),'attr_column'=>'import_information_3','attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'','attr_tyname'=>app::get('b2c')->_('系统'),'attr_order'=>'5','attr_group'=>'defalut'),
                array('attr_name'=>app::get('b2c')->_('资料配备（4)'),'attr_column'=>'import_information_4','attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'true','attr_edit'=>'false','attr_valtype'=>'number','attr_tyname'=>app::get('b2c')->_('系统'),'attr_order'=>'6','attr_group'=>'defalut'),
              );
     }

    static function get_ext_attr(){
          return  array(
            array('attr_name'=>app::get('b2c')->_('自定义字段'),'attr_column'=>'wangwang','attr_sdfpath'=>'contact/wangwang','attr_type'=>'text','attr_required'=>'false','attr_search'=>'false','attr_option'=>'','attr_show'=>'false','attr_edit'=>'false','attr_valtype'=>'alpha','attr_tyname'=>app::get('b2c')->_('自定义字段'),'attr_order'=>'14','attr_group'=>'contact')
        );
    }
    ...
    function gen_form(){
        $mem_schema = $this->app->model('gprovenance')->_columns();
