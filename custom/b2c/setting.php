...
'site.trigger_cancelorder' => array('type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('是否开启自动取消订单'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('开启该功能未支付的订单，超过一定时间未支付会被自动取消').'</span>','class'=>'site-trigger_cancelorder','javascript'=>'$$(".site-trigger_cancelorder").addEvent("click",function(e){var _el=e.target||e;if($(_el).getValue()=="true"){$$(".site-cancelorder_timelimit").getParent("tr").show();}else{$$(".site-cancelorder_timelimit").getParent("tr").hide();}});if($$(".site-trigger_cancelorder:checked").getValue()=="true"){$$(".site-cancelorder_timelimit").getParent("tr").show();}else{$$(".site-cancelorder_timelimit").getParent("tr").hide();}'),
'site.cancelorder_timelimit' => array('type'=>SET_T_INT,'default'=>'240','desc'=>app::get('b2c')->_('订单创建后支付时间'),'vtype'=>'required&&unsignedint','helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('小时&nbsp;&nbsp;&nbsp;请输入大于0整数（建议设置的值尽量大些），默认240小时（10天），在用户下单后超过该时间后未支付，订单将被取消').'</span>','class'=>'site-cancelorder_timelimit'),

'site.order_quota'=>array('id'=>'order_quota','type'=>SET_T_BOOL,'default'=>'false','desc'=>app::get('b2c')->_('是否设置满额度才能提交订单'),'javascript'=>'if(document.getElement("[name=\"set[site.order_quota]\"]:checked").value == "false") $$(".order_quota").getParent("tr").hide();'),//WZP
'site.order_quota_money'=>array('class'=>'order_quota','type'=>SET_T_STR,'default'=>'0.00','desc'=>app::get('b2c')->_('订单满'),'helpinfo'=>'<span class=\'notice-inline\'>'.app::get('b2c')->_('元，才能提交订单').'</span>','javascript'=>'$$("input[name^=set[site.order_quota_money]]").addEvent("change",function(e){var _target=$(e.target)||$(e);if (_target.value == "" || _target.value == "0") _target.value = "";});','vtype'=>'number'),//W
...
//api版本设置
'api.local.version'=>array('type'=>SET_T_INT,'default'=>'3.0'),
