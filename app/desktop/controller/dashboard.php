...
class desktop_ctl_dashboard extends desktop_controller{
    ...
    function advertisement(){
        try{
            $this->pagedata['url'] = kernel::single('syssupport_notice')->getNoticeIframeUrl();
        }catch(Exception $e){ }
...
//            $this->pagedata['cross_call_url'] =base64_encode( kernel::single('syssupport_notice')->getNoticeIframeUrl());
//        }catch(Exception $e){ }
//        $this->display('advertisement.html');
    }
