...
class weixin_ctl_admin_setting extends desktop_controller{
    ...
    public function index(){
        ...
        $setting['allowBindUser'] = app::get('weixin')->getConf('weixin_basic_setting.allowBindUser');
        $share_page = array(
...
//            'article-list'=>app::get('b2c')->_('文章列表页'),
    ...
    public function save_setting(){
        ...
        app::get('weixin')->setConf('weixin_basic_setting.allowBindUser', $_POST['allowBindUser']);
