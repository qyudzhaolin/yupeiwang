 ...
 */
final class wap_payment_plugin_teegonchinapayb2c extends ectools_payment_app  implements ectools_interface_payment_app {

    /**
     * @var string 支付方式名称
     */
    public $name = '天工收银（银联网关）';//快钱网上支付
    /**
     * @var string 支付方式接口名称
     */
    public $app_name = '天工收银接口';
    /**
     * @var string 支付方式key
     */
     ...
     * @var string 统一显示的名称
     */
    public $display_name = '天工收银(wap银联网关)';
    /**
     * @var string 货币名称
     */
    public $curname = 'CNY';
     ...
     */
    function intro(){
        return '<b><h3>'.app::get('ectools')->_('天工收银是商派软件2015年正式推出的C2B云收银服务，致力于为各类用户提供融合、便捷、安全的场景支付服务。</h3></b><bR> 天工全渠道收银服务，集成主流支付渠道，含银联网关、微信、银联等，支持B2B、B2C、B2B2C、C2C、O2O等各类场景，协助互联网用户或企业快速开展收银业务，拓展收银场景。</h3></b><bR>天工多角色分账服务，能为企业或平台中的各个角色按规则自动分账，轻松提升资金管理、流转效率，降低财务成本。</h3></b><bR>资金安全监管方：平安银行</h3></b><bR>到账周期：T＋2</h3></b><bR>');
    }
    ...
    function admin_intro(){
        return app::get('ectools')->_('天工收银是商派软件2015年正式推出的C2B云收银服务，致力于为各类用户提供融合、便捷、安全的场景支付服务。</h3></b><bR> 天工全渠道收银服务，集成主流支付渠道，含银联网关、微信、银联等，支持B2B、B2C、B2B2C、C2C、O2O等各类场景，协助互联网用户或企业快速开展收银业务，拓展收银场景。</h3></b><bR>天工多角色分账服务，能为企业或平台中的各个角色按规则自动分账，轻松提升资金管理、流转效率，降低财务成本。</h3></b><bR>资金安全监管方：平安银行</h3></b><bR>到账周期：T＋2</h3></b><bR>');
    }
    ...
    public function __construct($app)
    {
        ...
        $this->callback_url = kernel::openapi_url('openapi.ectools_payment/parse/wap/wap_payment_plugin_teegonchinapayb2c', 'callback');
    ...
    public function dopay($payment){
        ...
        //$return['notify_url'] = 'http://www.baidu.com';//支付成功后天工收银网关通知
