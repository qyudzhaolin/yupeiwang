...
class aftersales_finder_return_product
{
    ...
    public function detail_basic($return_id)
    {
        ...
        if($arr_return_product["customer_logistics"]){
            //获取顾客前台填写的物流信息
            $render->pagedata['customer_logistics_text'] = $obj_return_product->customer_logistics_text($arr_return_product["customer_logistics"]);
        }
