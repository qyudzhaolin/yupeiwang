                ...
                if($comment_id = $objComment->send($params, $params['object_type'], $message)){
                    ...
                    if($comment_display == 'soon' && $item == 'discuss' && $params['author_id']){
                        ...
                        if($_is_add_point){
                            ...
                            kernel::single('pointprofessional_point_common')->point_change_action($aData['author_id'],$_is_add_point,$msg,'comment_discuss',2,$params['goods_id'],$params['author_id'],'comment');
                        }
                    }
