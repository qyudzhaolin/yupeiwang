<?php
    class b2c_ctl_wap_activity extends wap_frontpage{
        ...
        public function __construct(&$app) {
            ...
            if ( isset($shopname) ) {
                $this->title = app::get('b2c')->_('活动页').'_'.$shopname;
                $this->keywords = app::get('b2c')->_('活动页').'_'.$shopname;
                $this->description = app::get('b2c')->_('活动页').'_'.$shopname;
            }
