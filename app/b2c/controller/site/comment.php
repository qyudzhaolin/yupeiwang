        ...
        if($comment_id = $objComment->send($aData, $item, $message)){
            ...
            if($comment_display == 'soon' && $item == 'discuss' && $aData['author_id']){
                ...
                if($_is_add_point){
                    ...
                    kernel::single('pointprofessional_point_common')->point_change_action($aData['author_id'],$_is_add_point,$msg,'comment_discuss',2,$aData['goods_id'],$aData['author_id'],'comment');
                }
            }
